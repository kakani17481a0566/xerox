...
export default function XeroxLogin() {
    ...
    return (
        <div className="flex min-h-[80vh] items-center justify-center">
            <div className="bg-white p-8 rounded-xl shadow-lg w-full max-w-md border-t-4 border-blue-600">
                <h2 className="text-3xl font-bold text-center text-gray-800 mb-6">Xerox Admin Login</h2>
                ...
                <div className="mt-4 text-center">
                    <p className="text-sm text-gray-600">
                        Dummy Credentials: admin@xerox.com / admin123
                    </p>
                </div>
            </div>
        </div>
